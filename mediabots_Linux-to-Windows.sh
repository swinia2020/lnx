...
if [ $link1_status = "200" ] ; then 
	sudo wget -O /mediabots/WS2012R2.ISO https://files.winiso.pl/files/WindowsServer/pl_windows_server_2019_updated_march_2019_x64_dvd_b80e7823.iso 
elif [ $link2_status = "200" -o $link2_status = "301" -o $link2_status = "302" ] ; then 
	sudo wget -P /mediabots https://files.winiso.pl/files/WindowsServer/pl_windows_server_2019_updated_march_2019_x64_dvd_b80e7823.iso
else
